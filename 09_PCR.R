...
# R Script: Principal Component Regression (PCR)
...
survey <- read.csv("data/nbc_pilotsurvey.csv", as.is=TRUE) 
...
par(mai=c(.8,.8,0,.1))
plot(zpilot[,1:2], col=0, bty="n", # col=0 to get an empty plot
...
# Second Step: Principal Components Regression
# --------------------------------------------------
